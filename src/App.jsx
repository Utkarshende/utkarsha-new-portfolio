...
import CERTIFICATIONS from "./configs/Certifications.js";
  ...
  return (
    <div className="flex h-screen">
      <button
        ...
        className="fixed md:hidden top-2 right-2 border border-gray-200 z-100 p-1 rounded-md bg-gray-100/60 backdrop-blur-xl"
      >
        {isNavOpen ? (
      ...
      <main className="p-6 mt-[-50px] md:p-12 overflow-y-auto " id="scrollableMain">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              onBtnClick={() => {
                window.open(
                  "https://drive.google.com/file/d/10VFUzRlCIG5IDLC2LNhiZnh3uJYPretD/view?usp=drive_link",
                  "_blank"
                );
        ...
        <Element name="certifications" className="pt-16">
          <H2
            headingTitle={"Certifications"}
            description={
              "These certifications highlight structured learning backed by practical implementation experience."
            }
          />
          <section className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 bg-gray-50 rounded shadow-md hover:shadow-xl transition duration-300  p-7 mt-5 sm:p-10">
            {CERTIFICATIONS.map((certification) => {
              return (
                <div key={certification?.title}>
                  ...
                  <a
                    href={certification?.to}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-3 text-sm font-medium text-cyan-600
                       hover:text-cyan-700 hover:underline transition"
                  >
                    View Certificate →
                  </a>
                </div>
  ...
  <section className="py-20">
    ...
    <div className="mt-12 flex justify-center">
      {PROJECTS_INFO.map((projectObj) => {
        ...
        <Element name="skills">
          <H2
            headingTitle={"Skills & Expertise"}
            description={
              "A comprehensive overview of my technical skills, tools, and soft skills that enable me to deliver high-quality software solutions."
            }
          />
